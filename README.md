...
2.  👔 **HR-бот** @aokayhr_bot - инструмент для HR-специалистов по управлению вакансиями и поиску сотрудников
...
### Партнерские купоны(В качестве примера):
...
CareerPilot - ваш надежный помощник в карьерном развитии! 🚀 @aokay_bot @aokayhr_bot
